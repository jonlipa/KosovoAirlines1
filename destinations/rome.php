...
class DestinationPage {
    private $conn;
    private $destination_id = 10; // ID e Romës në databazë
    ...
    private function processBooking() {
        ...
        if ($stmt->execute()) {
            $_SESSION['reservation_success'] = "✅ Reservation successful for $first_name $last_name to Rome from $departure_date to $return_date in $travel_class class.";
            header("Location: rome.php"); 
            exit();
        }
    ...
    public function render() {
        ...
        <head>
            ...
            <title>Rome, Italy - Kosova Airlines</title>
            <link rel="stylesheet" href="../css/destinations/rome.css">
        ...
        <body>
            ...
            <section class="destination-details">
                <h1>Rome, Italy</h1>
                <p>Rome, the Eternal City, is a treasure trove of history, culture, and stunning architecture. From the ancient Colosseum to the majestic Vatican City, Rome offers a journey through time and art.</p>
                <p>Explore landmarks like the Roman Forum, Trevi Fountain, and the Pantheon. Wander through its cobblestone streets, enjoy authentic Italian cuisine, and discover hidden piazzas.</p>
                <p>Did you know that Rome is over 2,700 years old? It was the heart of the Roman Empire, and its influence on law, architecture, and culture can still be felt worldwide.</p>
                <p>Rome is not just a city—it’s an experience, offering something unique at every corner for history buffs, art lovers, and food enthusiasts alike.</p>
            </section>

            <section class="image-gallery">
                <div class="gallery">
                    <img src="../images/rome1.jpg" alt="Rome Image 1" class="gallery-item">
                    <img src="../images/rome2.jpg" alt="Rome Image 2" class="gallery-item">
                    <img src="../images/rome3.jpg" alt="Rome Image 3" class="gallery-item">
                </div>
            </section>
            ...
            <section class="booking-form">
                <h2>Book Your Flight to Rome</h2>
                <form method="POST">
            ...
            <script defer src="../js/destinations/rome.js"></script>
