...
class DestinationPage {
    ...
    private function processBooking() {
        ...
        if ($stmt->execute()) {
            $_SESSION['reservation_success'] = "✅ Reservation successful for $first_name $last_name to Dubai from $departure_date to $return_date in $travel_class class.";
            header("Location: dubai.php"); 
            exit();
        }
    ...
    public function render() {
        ...
        <head>
            ...
            <title>Dubai, UAE - Kosova Airlines</title>
            <link rel="stylesheet" href="../css/destinations/dubai.css">
        ...
        <body>
            ...
            <section class="destination-details">
                <h1>Dubai, UAE</h1>
                <p>Dubai, a city of superlatives, is known for its luxury shopping, ultramodern architecture, and lively nightlife. Iconic landmarks include the Burj Khalifa, the tallest building in the world, and the Palm Jumeirah, an artificial archipelago shaped like a palm tree.</p>
                <p>Visitors can enjoy desert safaris, world-class dining, and unparalleled shopping experiences at destinations like the Dubai Mall and the Gold Souk. Dubai also boasts beautiful beaches, luxury resorts, and thrilling theme parks.</p>
                <p>Did you know that Dubai is home to the largest man-made marina in the world? It also hosts the annual Dubai Shopping Festival, which attracts millions of visitors from around the globe.</p>
                <p>With its blend of modernity and tradition, Dubai offers something for every traveler, making it one of the most popular destinations in the world.</p>

            <section class="image-gallery">
                <div class="gallery">
                    <img src="../images/dubai1.jpg" alt="Dubai Image 1" class="gallery-item">
                    <img src="../images/dubai2.jpg" alt="Dubai Image 2" class="gallery-item">
                    <img src="../images/dubai3.jpg" alt="Dubai Image 3" class="gallery-item">
                </div>
            </section>
            ...
            <section class="booking-form">
                <h2>Book Your Flight to Dubai</h2>
                <form method="POST">
            ...
            <script defer src="../js/destinations/dubai.js"></script>
