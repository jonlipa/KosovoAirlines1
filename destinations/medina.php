...
class DestinationPage {
    private $conn;
    private $destination_id = 6; // ID e Medinës në databazë
    ...
    private function processBooking() {
        ...
        if ($stmt->execute()) {
            $_SESSION['reservation_success'] = "✅ Reservation successful for $first_name $last_name to Medina from $departure_date to $return_date in $travel_class class.";
            header("Location: medina.php"); 
            exit();
        }
    ...
    public function render() {
        ...
        <head>
            ...
            <title>Medina, Saudi Arabia - Kosova Airlines</title>
            <link rel="stylesheet" href="../css/destinations/medina.css">
        ...
        <body>
            ...
            <section class="destination-details">
                <h1>Medina, Saudi Arabia</h1>
                <p>Medina, also known as Al-Madinah Al-Munawwarah, is one of the holiest cities in Islam. It is home to the Prophet's Mosque, an important religious site visited by millions of pilgrims every year.</p>
                <p>The city is rich in history and culture, offering a peaceful and spiritual environment. Medina is known for its hospitable locals and serene surroundings, making it a unique destination for visitors.</p>
                <p>Whether you come for religious reasons or to explore its historical sites, Medina offers an unforgettable experience.</p>
            </section>

            <section class="image-gallery">
                <div class="gallery">
                    <img src="../images/medina1.jpg" alt="Medina Image 1" class="gallery-item">
                    <img src="../images/medina2.jpg" alt="Medina Image 2" class="gallery-item">
                    <img src="../images/medina3.jpg" alt="Medina Image 3" class="gallery-item">
                </div>
            </section>
            ...
            <section class="booking-form">
                <h2>Book Your Flight to Medina</h2>
                <form method="POST">
            ...
            <script defer src="../js/destinations/medina.js"></script>
